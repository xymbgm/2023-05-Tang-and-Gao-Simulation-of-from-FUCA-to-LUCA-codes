		...
		switch rndIndexAA {
			match 1 {
				if (self.type <= 30) {
					...
					create AA1 number: rnd(60, 120) returns: AA1Group;
					firstTenGroup <<+ AA1Group;	
				}				
			}
			match 2 {
				if (self.type <= 30) {
					...
					create AA2 number: rnd(60, 120) returns: AA2Group;
					firstTenGroup <<+ AA2Group;	
				}
			}
			match 3 {
				if (self.type <= 30) {
					...
					create AA3 number: rnd(60, 120) returns: AA3Group;
					firstTenGroup <<+ AA3Group;	
				}
			}
			match 4 {
				if (self.type <= 30) {
					...
					create AA4 number: rnd(60, 120) returns: AA4Group;
					firstTenGroup <<+ AA4Group;	
				}
			}
			match 5 {
				if (self.type <= 30) {
					...
					create AA5 number: rnd(60, 120) returns: AA5Group;
					firstTenGroup <<+ AA5Group;	
				}
			}
			match 6 {
				if (self.type <= 30) {
					...
					create AA6 number: rnd(60, 120) returns: AA6Group;
					firstTenGroup <<+ AA6Group;	
				}
			}
			match 7 {
				if (self.type <= 30) {
					...
					create AA7 number: rnd(60, 120) returns: AA7Group;
					firstTenGroup <<+ AA7Group;	
				}
			}
			match 8 {
				if (self.type <= 30) {
					...
					create AA8 number: rnd(60, 120) returns: AA8Group;
					firstTenGroup <<+ AA8Group;	
				}
			}
			match 9 {
				if (self.type <= 30) {
					...
					create AA9 number: rnd(60, 120) returns: AA9Group;
					firstTenGroup <<+ AA9Group;	
				}
			}
			match 10 {
				if (self.type <= 30) {
					...
					create AA10 number: rnd(60, 120) returns: AA10Group;
					firstTenGroup <<+ AA10Group;	
				}
			}						
		}
